...
parser.add_argument("--confidence-file", type=str, default="shapes-confidence", help="path to confidence txt file that will be created")
parser.add_argument("--output-file", type=str, default="shapes-output", help="path to output txt file that will be created")
...
if os.path.isdir(confidence-path):
    ...
    os.system("mkdir %s"%confidence-path)
    a = open(confidence-path + '/confidence.txt','w')
	
if os.path.isdir(output-path):
    b = open(output-path + '/output.txt', 'w')
else:
    os.system("mkdir %s"%output-path)
    b = open(output-path + '/output.txt', 'w')
